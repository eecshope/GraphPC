...
class ASTDataset(DGLDataset):
    def __getitem__(self, idx):
        return self.graphs[idx], self.label_dict["labels"][idx]
    ...
    def __init__(self, data_type, raw_dir=None, save_dir=None):
        super(DGLDataset, self).__init__(raw_dir=raw_dir, save_dir=save_dir)
    ...
    def load(self):
        ...
        self.n_labels = torch.max(self.label_dict["labels"].item())
